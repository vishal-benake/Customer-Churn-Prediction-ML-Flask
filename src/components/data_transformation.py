...
from src.utils import clean_input_data
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            input_columns_with_blanks = ["TotalCharges", "MonthlyCharges", "tenure"]  # adjust if needed

            for col in input_columns_with_blanks:
            ...
            train_df = clean_input_data(train_df)
            test_df = clean_input_data(test_df)
            ...
            preprocessing_obj.fit(input_feature_test_df, target_feature_test_df)
            input_feature_test_arr = preprocessing_obj.transform(input_feature_test_df)
